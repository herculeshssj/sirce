...
<f:view>
    ...
    <div id="content">
        ...
        <div class="post" id="post-01">
            ...
            <h1 class="post-title"><a href="#" rel="bookmark">Consultas Marcadas</a></h1>
            <br/><br/>
            <h:form id="lstConsulta">
                <h:messages style="font-weight: bold;"/>
                Informe o código da consulta:
                <h:inputText value="#{ConsultaMB.busca}" />
                &nbsp;
                <h:commandButton value="Pesquisar" action="#{ConsultaMB.pesquisar}"  style="padding: 3px 10px;"/>
                <br/><br/>
                <h:dataTable id="tableExame" value="#{ConsultaMB.listaConsultas}" var="item" width="100%" style="text-align:center" styleClass="jsflist" >
                    ...
                    <h:column>
                        ...
                        <h:commandLink value="Registrar" action="#{ConsultaMB.registrar}">
                        ...
                        <f:facet name="header">
                            ...
                            <h:commandLink value="Desmarcar" action="#{ConsultaMB.desmarcar}">
                                <f:setPropertyActionListener target="#{ConsultaMB.idConsulta}" value="#{item.id}"/>
                        </h:commandLink>
                    </h:column>
