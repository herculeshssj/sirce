...
<f:view>
    ...
    <div id="content">
        ...
        <div class="post" id="post-01">
            ...
            <h1 class="post-title"><a href="#" rel="bookmark">Exames Marcados</a></h1>
            <br/><br/>
            <h:form id="lstExame">
                <h:messages style="font-weight: bold;"/>
                Informe o nome do paciente:
                <h:inputText value="#{ExameMB.busca}" />
                &nbsp;
                <h:commandButton value="Pesquisar" action="#{ExameMB.pesquisar}"  style="padding: 3px 10px;"/>
                <br/><br/>
                <h:dataTable id="tableExame" value="#{ExameMB.listaExames}" var="item" width="100%" style="text-align:center" styleClass="jsflist" >
                    ...
                    <h:column>
                        ...
                        <h:commandLink value="Registrar" action="#{ExameMB.registrar}" onclick="javascript:return(confirm('Deseja registrar este exame?'))">
                            <f:setPropertyActionListener target="#{ExameMB.idExame}" value="#{item.id}"/>
                        </h:commandLink>
                    </h:column>
                        <h:column>
                        <f:facet name="header">
                            ...
                            <h:commandLink value="Desmarcar" action="#{ExameMB.desmarcar}" onclick="javascript:return(confirm('Deseja desmarcar este exame?'))">
                                <f:setPropertyActionListener target="#{ExameMB.idExame}" value="#{item.id}"/>
                        </h:commandLink>
                    </h:column>
