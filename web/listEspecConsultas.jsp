...
<f:view>
    ...
    <div id="content">
        ...
        <div class="post" id="post-01">
            ...
            <h1 class="post-title"><a href="#" rel="bookmark">Consultas Marcadas [Especialidades]</a></h1>
            <br/><br/>
            <h:form id="lstConsulta">
                ...
                <h:selectOneMenu id="txtEspecialidade" value="#{ConsultaMB.idEspecialidade}">
                            ...
                            <f:selectItems value="#{ConsultaMB.listaEspecialidades}"/>
                        </h:selectOneMenu>
                &nbsp;
                <h:commandButton value="Pesquisar" action="#{ConsultaMB.pesquisaEspecialidade}"  style="padding: 3px 10px;"/>
                <br/><br/>
