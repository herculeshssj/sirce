...
package br.com.hslife.sirce.validacao;

import br.com.hslife.sirce.util.CPF;
 ...
 * @author Hércules
 */
public class CpfValidar implements Validator{
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        ...
        if (!CPF.validaCPF(cpf)) {
            FacesMessage mensagem = new FacesMessage("CPF informado é inválido!");
